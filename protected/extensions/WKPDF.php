<?php
        ...
        $GLOBALS['WKPDF_BASE_PATH']='/var/share/';//str_replace(str_replace('\\','/',getcwd().'/'),'',dirname(str_replace('\\','/',__FILE__))).'/';
        ...
        class WKPDF {
                ...
                public function render(){
                		copy($GLOBALS['WKPDF_BASE_PATH'].'tmp/'.basename($this->tmp), '/var/www/tmp/'.basename($this->tmp));
