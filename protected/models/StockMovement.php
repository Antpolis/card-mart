 ...
 */
class StockMovement extends CActiveRecord
{
	/**
	 ...
	 */
	const _NORMALSTOCK = 0;
	const _RETAILSTOCK = 1;
	...
	public $stockTypeArrayForDropDown = array(
		self::_NORMALSTOCK=>'Normal Stock',
		self::_RETAILSTOCK=>'Retail Stock',
	);
	...
	public function rules()
	{
		...
		return array(
			...
			array('stockType','default','value'=>self::_NORMALSTOCK),
			...
			array('itemID, qty, movementType, remark, id, userID, quotationID,stockType', 'safe', 'on'=>'search'),
		);
	}
